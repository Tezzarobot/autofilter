...
○ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 3 
○ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ ᴀsʏɴᴄɪᴏ 0.17.1
○ sᴇʀᴠᴇʀ : ᴄᴏɴᴛᴀʙᴏ
○ ᴅᴀᴛᴀʙᴀsᴇ : <a href='https://www.mongodb.com'>ᴍᴏɴɢᴏᴅʙ ғʀᴇᴇ ᴛɪᴇʀ</a>
○ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ9.8 [ʙᴇᴛᴀ]
"""
    SOURCE_TXT = """<b>NOTE:</b>
- ᴘᴏᴏᴊᴀ ʜᴇɢᴅᴇ ɪs ᴀ ᴏᴘᴇɴ sᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ ʙʏ ᴛᴇᴀᴍ @Gw_links  

CODES:

» https://github.com/tezzarobot/autofilter
"""
...
- 𝖣𝗈𝗎𝖻𝗅𝖾 𝖻𝗎𝗍𝗍𝗈𝗇 
<code>[𝖡𝗎𝗍𝗍𝗈𝗇𝟣](𝖻𝗎𝗍𝗍𝗈𝗇𝗎𝗋𝗅:https://𝗍.𝗆𝖾/gw_links)
[𝖡𝗎𝗍𝗍𝗈𝗇𝟤](𝖻𝗎𝗍𝗍𝗈𝗇𝗎𝗋𝗅:https://𝗍.𝗆𝖾/goodwillmovies)</code>
